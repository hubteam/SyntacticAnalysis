 ...
 *
 */
public class SyntacticAnalysisContextGeneratorConfContainsPos implements SyntacticAnalysisContextGeneratorContainsPos{
	...
	public String[] getContext(int index, String[] words, String[] poses, Object[] arg3) {
      ...
      //这里特征有两种，当前词的个数小于，与大于等于5
        ...
        if(FeatureContainsPosTools.overFive(w0)){
        	...
        	if(FeatureContainsPosTools.isAlbDigit(w0)){
        	...
        	if(FeatureContainsPosTools.isLetter(w0)){
