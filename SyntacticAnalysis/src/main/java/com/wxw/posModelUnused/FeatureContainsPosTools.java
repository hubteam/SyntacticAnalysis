 ...
 *
 */
public class FeatureContainsPosTools {

	private static HashMap<String,Integer> dict;
	
	static HashSet<Character> hsalbdigit = new HashSet<>();
	
	public FeatureContainsPosTools(){
		
	}
	
	public FeatureContainsPosTools(HashMap<String,Integer> dict){
		FeatureContainsPosTools.dict = dict;
	}
