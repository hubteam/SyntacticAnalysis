...
public class SyntacticAnalysisEvaluatorForOneStep extends Evaluator<SyntacticAnalysisSample>{
	...
	public SyntacticAnalysisEvaluatorForOneStep(POSTaggerME postagger,SyntacticAnalysisME treetagger) {
		this.postagger = postagger;
		this.treetagger = treetagger;
	}
	
	public SyntacticAnalysisEvaluatorForOneStep(POSTaggerME postagger,SyntacticAnalysisME treetagger,SyntacticAnalysisEvaluateMonitor... evaluateMonitors) {
